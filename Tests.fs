...
: TEST-LOOKUP
    ARRAY DUP 20 CELLS + SWAP DO I @ . CELL +LOOP CR
    256 ARRAY 0  LOOK-UP ASSERT( FALSE EQUALS )
    256 ARRAY 20 LOOK-UP ASSERT( FALSE EQUALS )
    456 ARRAY 20 LOOK-UP ASSERT( TRUE  EQUALS ) DROP
;
