...
: TEST-ALT-INF
    ...
    6 0 DO SRCE I + C-ARRAY I CELLS + ! LOOP
    C-ARRAY 6 SORT
    6 0 DO C-ARRAY I CELLS + @ C@ DEST I + C! LOOP
...
: TEST-LOOKUP-IN-1-ITEM-ARRAY
    0 A 1 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A EQUALS )
    3 A 1 LOOK-UP ASSERT( FALSE EQUALS ) ;

: TEST-LOOKUP-IN-2-ITEM-ARRAY
    0 A 2 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A EQUALS ) 
    5 A 2 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A CELL+ EQUALS )
...
: TEST-LOOKUP-IN-3-ITEM-ARRAY
    5 A 3 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A CELL+ EQUALS ) 
    0 A 3 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A EQUALS ) 
    12 A 3 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A CELL+ CELL+ EQUALS ) 
...
: TEST-LOOKUP-IN-4-ITEM-ARRAY
    5 A 4 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A CELL+ EQUALS ) 
    0 A 4 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A EQUALS ) 
    12 A 4 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A CELL+ CELL+ EQUALS ) 
    ...
    34 A 4 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( A 3 CELLS + EQUALS )
...
: TEST-ALT-LOOKUP
    [CHAR] A C 4 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( C EQUALS ) 
    [CHAR] C C 4 LOOK-UP ASSERT( TRUE EQUALS ) ASSERT( C 2 CELLS + EQUALS ) 
